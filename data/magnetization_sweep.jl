...
for ρi in 0:0.001:0.999 for βi in 0.01:0.01:10
    ...
    mag[findin(0:0.001:0.999, ρi), findin(0.01:0.01:10, βi)] = abs(magnetization(soc, x))
...
imshow(mag, extent=[0, 1, 0, 10], aspect="auto", interpolation="nearest")
colorbar()

savefig("data/magnetization.png")
